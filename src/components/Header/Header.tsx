  ...
  return (
    ...
    '>
      <div className='px-6 h-full flex items-center justify-between'>
        <form action="" className='max-w-[460px] w-full'>
          <div className='w-full relative'>
            <button className='absolute top-1/2 -translate-y-1/2 left-3 dark:text-white'><FontAwesomeIcon icon={faSearch} /></button>
            <input className='w-[95%] py-2 pl-10 pr-3 outline-none rounded-md border border-gray-300 focus:border-gradientBlue dark:border-slate-500 dark:bg-darkBlur dark:focus:border-gradientBlue dark:text-white' type="search" placeholder='Search song title, artist, genre...' />
          </div>
        </form>
